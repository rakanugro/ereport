...
class ExportMenuController extends Controller
{
    /**
    ...
    public function list_export_menu(Request $request)
    {
        ...
        return view('exportdata.list_export_menu', [
            'now'                   => $now,
    ...
    public function list_export_menu_excel(Request $request)
    {
        ...
        return view('exportdata.list_export_menu_excel', [
            'now'                   => $now,
            'directorat_list'   => $directorat_list,
            'subdiv_list' => $subdiv_list,
            'indicator_list' => $indicator_list,
    ...
    public function previewtidaktercapaicabang(Request $request)
        ...
        public function previewindikatorkpi(Request $request)
        {
            //dd($request);
            $years = $request->years;
            $triwulan = $request->period;
            $cbg = $request->pusatcab;
