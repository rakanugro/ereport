		...
		<div class="fl-container">
			<div class="fl-title-page" >
				<span style="font-size:20px">				
					...
					Edit Sasaran Mutu Per {{ $month }} {{ $year }}
				</span>
					...
					@foreach($sarmut_list as $data)
						...
						<tbody>
							<tr>
								...
								<td>
									@if( $data->INPUTABLE == "Y")
									<input style="width: 100% !important;" class="col-md-10 uk-input" class="col-md-6 uk-input" type="number" step="any" name="actual[]" id="actual{{$i}}" value="{{ $sel_actual_list[$i]->SELECTED }}" placeholder="Realisasi" {{ 'required="required"' }}></td>
									@elseif( $data->INPUTABLE == "N" )
									<input style="width: 100% !important; background-color: #f0f5f5	 !important;" class="col-md-10 uk-input" class="col-md-6 uk-input" type="number" step="any" name="actual[]" id="actual{{$i}}" value="{{ $sel_actual_list[$i]->SELECTED }}" placeholder="Realisasi" {{ 'required="required"' }}></td>
									@endif
								<td>
									@if($data->INPUTABLE == "Y" )
					...
					@endforeach
						...
						<tbody>
							<tr>
								...
								<td></td>
								<td>
									@if((Auth::user()->ACCESS == 'ADMIN SUB DIVISI') || (Auth::user()->ACCESS == 'ADMIN PENGENDALIAN KINERJA DAN JAMINAN MUTU') && $status == '1' || $status == '4')
									<button class="uk-button uk-button-primary fl-button" type="submit">Update</button>
									@endif
								</td>
								<td>
