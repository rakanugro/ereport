		...
		<div class="fl-header fl-header-margin" uk-sticky>
			<div>
				...
				<span class="fl-menu-tool">
					...
					<input type="button" class="uk-button uk-button-primary fl-button" value="menu" onclick="location.href = '{{ url('dashboard')}}'">				</span>
				<!-- <span class="fl-menu-tool">
		...
		<div class="fl-container">
			<div class="fl-title-page" >
				<span style="font-size:20px">				
					...
					Detail Master Sasaran Mutu
				</span>
			</div>
			
			<div class="fl-table">
				<form id="form_mst_sarmut" action="#" method="POST">
				{{ csrf_field() }}
					...
					<div class="form-group m-form__group row">
						...
						<div class="form-group m-form__group row">
							<div class="col-lg-7">
								...
								<br>
								<select style="width: 85% !important;" id="tipepenjumlahan" class="form-control select2-list" name="tipepenjumlahan" disabled="disabled">
