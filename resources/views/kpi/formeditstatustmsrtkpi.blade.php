		...
		<div class="fl-container">
			<div class="fl-title-page" >
				<span style="font-size:20px">				
					...
					Edit Status Master KPI
				</span>
			</div>
			
			<div class="fl-table">
				<form id="form_mst_kpi" action="/kpi/save_edit_status_mst_indikator_kpi" method="POST">
				{{ csrf_field() }}
					...
					<div class="form-group m-form__group row">
						...
						<div class="form-group m-form__group row">
							<div class="col-lg-7">
								...
								<br>
								<select style="width: 85% !important;" id="polaritas" class="form-control select2-list" name="polaritas" disabled="disabled">
						...
						<div class="form-group m-form__group row">
							<div class="col-lg-7">
								...
								<select style="width: 85% !important;" id="perspective" class="form-control select2-list" name="perspective" disabled="disabled">
						...
						<div class="form-group m-form__group row">
							<div class="col-lg-7">
								...
								<br>
								<select style="width: 85% !important;" id="branchoffice_list" class="form-control select2-list" name="branchoffice_list" disabled="disabled">
						...
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
								...
								<input name="minscore" class="uk-input uk-child-width-1-2" type="number" value="{{$minscore}}" placeholder="Min. Score" disabled="disabled">
							</div>
						</div>
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
								...
								<input name="maxscore" class="uk-input uk-child-width-1-2" type="number" value="{{$maxscore}}" placeholder="Max. Score" disabled="disabled">
							</div>
						</div>
						<div class="form-group m-form__group row">
							<div class="col-lg-7">
								...
								<select style="width: 85% !important;" id="laporankpi" class="form-control select2-list" name="laporankpi" disabled="disabled">
						...
						<div class="form-group m-form__group row">
							...
							<div class="col-lg-6">
								...
								<textarea id="formula_alias" name="formula_alias" class="uk-input uk-child-width-1-2"  type="text" disabled>{{$formulaalias}}</textarea>
							</div>
						</div>
						<div class="form-group m-form__group row">
							<div class="col-lg-7">
								...
								<br>
								<select style="width: 85% !important;" id="status" class="form-control select2-list" name="status" required="required">
