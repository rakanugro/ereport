		...
		<div class="fl-container">
			<div class="fl-title-page" >
				<span style="font-size:20px">				
					...
					Form Detail Master KPI
				</span>
			</div>
			
			<div class="fl-table">
				<form id="form_mst_kpi" action="#" method="POST">
				{{ csrf_field() }}
					...
					<div class="form-group m-form__group row">
						...
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
								...
								<input name="minscore" class="uk-input uk-child-width-1-2" type="number" value="{{$minscore}}" placeholder="Min. Score" disabled>
							</div>
						</div>
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
								...
								<input name="maxscore" class="uk-input uk-child-width-1-2" type="number" value="{{$maxscore}}" placeholder="Max. Score" disabled>
							</div>
						</div>
						<div class="form-group m-form__group row">
							<div class="col-lg-7">
