...
<body>
	...
	<div class="fl-main-container">
		...
		<form id="form_kpi" action="#" method="POST">	
					...
					@endforeach
						...
						<tbody>
							<tr>
								...
								<td></td>
								<td>
									<button class="uk-button uk-button-danger fl-button" type="button" onclick="location.href = '{{ url('txkpi')}}'">Back</button>
								</td>
								<td></td>
							</tr>
						</tbody>
...
<script type="text/javascript">
    ...
    {   
		document.forms['form_apprkpi'].submit();
    }
