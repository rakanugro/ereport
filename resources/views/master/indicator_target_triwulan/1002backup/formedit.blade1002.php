							...
							<td width="50%">
								<table class="uk-table uk-table-hover uk-table-middle uk-table-divider">
									...
									<tbody>
											<tr>
												<td>Januari</td>
												<td><input name="TARGET_JAN" id="TARGET_JAN" class="uk-input uk-child-width-1-2" type="number" step="any" value="" onkeyup="myFunction()" placeholder="Target" required></td>
												<!-- <td><input name="bobot_januari" class="uk-input uk-child-width-1-2" type="number" value="{{ $BOBOT_JAN }}" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>Februari</td>
												<td><input name="TARGET_FEB" id="TARGET_FEB" class="uk-input uk-child-width-1-2" type="number" step="any" value="{{ $TARGET_FEB }}" placeholder="Target" required></td>
												<!-- <td><input name="bobot_februari" class="uk-input uk-child-width-1-2" type="number" value="{{ $BOBOT_FEB }}" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>Maret</td>
												<td><input name="TARGET_MAR" id="TARGET_MAR" class="uk-input uk-child-width-1-2" type="number" step="any" value="{{ $TARGET_MAR }}" placeholder="Target" required></td>
												<!-- <td><input name="bobot_maret" class="uk-input uk-child-width-1-2" type="number" value="{{ $BOBOT_MAR }}" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>April</td>
												<td><input name="TARGET_APR" id="TARGET_APR" class="uk-input uk-child-width-1-2" type="number" step="any" value="{{ $TARGET_APR }}" placeholder="Target" required></td>
												<!-- <td><input name="bobot_april" class="uk-input uk-child-width-1-2" type="number" value="{{ $BOBOT_APR }}" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>Mei</td>
												<td><input name="TARGET_MAY" id="TARGET_MAY" class="uk-input uk-child-width-1-2" type="number" step="any" value="{{ $TARGET_MAY }}" placeholder="Target" required></td>
											...
											<tr>
												<td>Juli</td>
												<td><input name="TARGET_JUL" id="TARGET_JUL" class="uk-input uk-child-width-1-2" type="number" step="any" value="{{ $TARGET_JUL }}" placeholder="Target" required></td>
												<!-- <td><input name="bobot_juli" class="uk-input uk-child-width-1-2" type="number" value="{{ $BOBOT_JUL }}" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>Agustus</td>
												<td><input name="TARGET_AUG" id="TARGET_AUG" class="uk-input uk-child-width-1-2" type="number" step="any" value="{{ $TARGET_AUG }}" placeholder="Target" required></td>
												<!-- <td><input name="bobot_agustus" class="uk-input uk-child-width-1-2" type="number" value="{{ $BOBOT_AUG }}" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>September</td>
												<td><input name="TARGET_SEP" id="TARGET_SEP" class="uk-input uk-child-width-1-2" type="number" step="any" value="{{ $TARGET_SEP }}" placeholder="Target" required></td>
											...
											<tr>
												<td>Oktober</td>
												<td><input name="TARGET_OCT" id="TARGET_OCT" class="uk-input uk-child-width-1-2" type="number" step="any" value="{{ $TARGET_OCT }}" placeholder="Target" required></td>
												<!-- <td><input name="bobot_oktober" class="uk-input uk-child-width-1-2" type="number" value="{{ $BOBOT_OCT }}" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>November</td>
												<td><input name="TARGET_NOV" id="TARGET_NOV" class="uk-input uk-child-width-1-2" type="number" step="any" value="{{ $TARGET_NOV }}" placeholder="Target" required></td>
												<!-- <td><input name="bobot_november" class="uk-input uk-child-width-1-2" type="number" value="{{ $BOBOT_NOV }}" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>Desember</td>
												<td><input name="TARGET_DES" id="TARGET_DES" class="uk-input uk-child-width-1-2" type="number" step="any" value="{{ $TARGET_DES }}" placeholder="Target" required></td>
...
<script>
	...
	function myFunction() {
		var target = document.getElementById('TARGET_JAN');
		console.log(target.value);
		document.getElementById('TARGET_FEB').value = target.value;
		document.getElementById('TARGET_MAR').value = target.value;
		document.getElementById('TARGET_APR').value = target.value;
		document.getElementById('TARGET_MAY').value = target.value;
		document.getElementById('TARGET_JUN').value = target.value;
		document.getElementById('TARGET_JUL').value = target.value;
		document.getElementById('TARGET_AUG').value = target.value;
		document.getElementById('TARGET_SEP').value = target.value;
		document.getElementById('TARGET_OCT').value = target.value;
		document.getElementById('TARGET_NOV').value = target.value;
		document.getElementById('TARGET_DES').value = target.value;
	}
