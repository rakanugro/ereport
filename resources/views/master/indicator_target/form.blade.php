		...
		<div class="fl-container">
			...
			<div class="fl-table">
				...
				{{ csrf_field() }}
					...
					<!-- <div>
						<b>Unit</b>
						<input name="unit" class="uk-input uk-child-width-1-2" type="text" value="" id="unit" placeholder="Unit" readonly>
                        </select>
					</div> -->
					<div><br></div>
					<div> 
							...
							<td width="50%">
								<table class="uk-table uk-table-hover uk-table-middle uk-table-divider">
									...
									<tbody>
											<tr>
												<td>Januari</td>
												<td><input name="target_januari" id="target_januari" class="uk-input uk-child-width-1-2" type="number" onkeyup="myFunction()" placeholder="Target" required></td>
												<!-- <td><input name="bobot_januari" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>Februari</td>
												<td><input name="target_februari" id="target_februari" class="uk-input uk-child-width-1-2" type="number" placeholder="Target" required></td>
												<!-- <td><input name="bobot_februari" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>Maret</td>
												<td><input name="target_maret" id="target_maret" class="uk-input uk-child-width-1-2" type="number" placeholder="Target" required></td>
												<!-- <td><input name="bobot_maret" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>April</td>
												<td><input name="target_april" id="target_april" class="uk-input uk-child-width-1-2" type="number" placeholder="Target" required></td>
												<!-- <td><input name="bobot_april" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>Mei</td>
												<td><input name="target_mei" id="target_mei" class="uk-input uk-child-width-1-2" type="number" placeholder="Target" required></td>
												<!-- <td><input name="bobot_mei" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>Juni</td>
												<td><input name="target_juni" id="target_juni" class="uk-input uk-child-width-1-2" type="number" placeholder="Target" required></td>
												<!-- <td><input name="bobot_juni" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>Juli</td>
												<td><input name="target_juli" id="target_juli" class="uk-input uk-child-width-1-2" type="number" placeholder="Target" required></td>
												<!-- <td><input name="bobot_juli" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>Agustus</td>
												<td><input name="target_agustus" id="target_agustus" class="uk-input uk-child-width-1-2" type="number" placeholder="Target" required></td>
												<!-- <td><input name="bobot_agustus" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>September</td>
												<td><input name="target_september" id="target_september" class="uk-input uk-child-width-1-2" type="number" placeholder="Target" required></td>
												<!-- <td><input name="bobot_september" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>Oktober</td>
												<td><input name="target_oktober" id="target_oktober" class="uk-input uk-child-width-1-2" type="number" placeholder="Target" required></td>
												<!-- <td><input name="bobot_oktober" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>November</td>
												<td><input name="target_november" id="target_november" class="uk-input uk-child-width-1-2" type="number" placeholder="Target" required></td>
												<!-- <td><input name="bobot_november" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot" required></td> -->
											</tr>
											<tr>
												<td>Desember</td>
												<td><input name="target_desember" id="target_desember" class="uk-input uk-child-width-1-2" type="number" placeholder="Target" required></td>
							...
							<!-- <td width="50%" valign="top">
								<table class="uk-table uk-table-hover uk-table-middle uk-table-divider">
									...
									<tbody>
											<tr>
												<td>Triwulan 1</td>
												<td><input name="target_triwulan1" class="uk-input uk-child-width-1-2" type="number" placeholder="Target"></td>
												<td><input name="bobot_triwulan1" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot"></td>
											</tr>
											<tr>
												<td>Triwulan 2</td>
												<td><input name="target_triwulan2" class="uk-input uk-child-width-1-2" type="number" placeholder="Target"></td>
												<td><input name="bobot_triwulan2" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot"></td>
											</tr>
											<tr>
												<td>Triwulan 3</td>
												<td><input name="target_triwulan3" class="uk-input uk-child-width-1-2" type="number" placeholder="Target"></td>
												<td><input name="bobot_triwulan3" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot"></td>
											</tr>
											<tr>
												<td>Triwulan 4</td>
												<td><input name="target_triwulan4" class="uk-input uk-child-width-1-2" type="number" placeholder="Target"></td>
												<td><input name="bobot_triwulan4" class="uk-input uk-child-width-1-2" type="number" placeholder="Bobot"></td>
											</tr>
