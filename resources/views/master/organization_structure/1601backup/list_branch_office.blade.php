		...
		<div class="fl-container">
			<div class="fl-title-page" >
				...
				<!-- <span style="float:right;margin-top:15px">
					...
					<a href="form_branchoffice"><button class="uk-button uk-button-primary fl-button" type="button">+</button></a>
					@endif
				</span>
			</div>
			<div class="fl-table">
				<div class="uk-overflow-auto">
					<table class="uk-table uk-table-hover uk-table-middle uk-table-divider" id="branchofficelist">
						<thead>
							<tr class="fl-table-head">
								<th width="5%"></th>
								<th width="20%">BRANCH OFFICE CODE</th>
								<th width="20%">BRANCH OFFICE NAME</th>
								<th width="20%">Active</th>
								<th width="20%">Action</th>
							</tr>
						</thead>
						<tbody>	
							@foreach($list_branchoffice as $items)
							<tr>
								<td><img class="uk-preserve-width uk-border-circle" src="{{ URL::asset('templateslide/assets/img/icon/i1.png') }}" width="45" alt=""></td>
								<td>{{ $items->BRANCH_OFFICE_CODE }}</td>
								...
								<td>
									...
									<div uk-dropdown="mode:click">
										<ul class="uk-nav uk-dropdown-nav">
											<li><a href="/master/form_edit_branchoffice/{{$items->BRANCH_OFFICE_ID}}">Edit</a></li>
											<li><a href="/master/form_status_branchoffice/{{$items->BRANCH_OFFICE_ID}}">Status</a></li>
										</ul>
									</div>
								</td>
							</tr>
