	...
	<div class="fl-main-container">
		...
		<div class="fl-container">
			<div class="fl-title-page" >
				...
				<div class="fl-table">
					<form id="form_blade" action="/master/save_branchoffice_edit" method="POST">
						{{ csrf_field() }}
						<div class="form-group m-form__group row">
							...
							<div class="col-lg-4">
								...
								<input name="branchoffice_code" id="branchoffice_code" class="uk-input uk-child-width-1-2" type="text" onchange="check_code()" placeholder="Branch Office Code" value="{{$codebranchoffice}}" required>
						...
						<div class="form-group m-form__group row">
							<div class="col-lg-4">
								...
								<input name="branchoffice_name" id="branchoffice_name" class="uk-input uk-child-width-1-2" type="text" placeholder="Branch Office Name" value="{{$namebranchoffice}}" required>
							</div>
						</div>
						<div class="form-group m-form__group row">
							<div class="col-lg-4">
