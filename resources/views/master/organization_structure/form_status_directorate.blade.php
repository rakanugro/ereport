	...
	<div class="fl-main-container">
		...
		<div class="fl-container">
			<div class="fl-title-page" >
				...
				<div class="fl-table">
					<form id="form_blade" action="/master/save_directorate_status" method="POST">
						{{ csrf_field() }}
						<div class="form-group m-form__group row">
							...
							<div class="col-lg-4">
								...
								<input name="directorate_code" id="directorate_code" class="uk-input uk-child-width-1-2" type="text" placeholder="Directorate Code" value="{{$dircode}}" disabled>
						...
						<div class="form-group m-form__group row">
							<div class="col-lg-4">
								...
								<input name="directorate_name" id="directorate_name" class="uk-input uk-child-width-1-2" type="text" value="{{$dirname}}" placeholder="Directorate Name" disabled>
							</div>
						</div>
						<div class="form-group m-form__group row">
							<div class="col-lg-4">
								...
								<select class="form-control select2-list" name="is_cabang" id="is_cabang" disabled>
