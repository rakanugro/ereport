		...
		<div class="fl-container">
			<div class="fl-title-page" >
				<span style="font-size:20px">				
					...
					Save List Directorate
				</span>

				<div class="fl-table">
					<form id="form_blade" action="/master/list_directorate_save" method="POST">
						{{ csrf_field() }}
						<div class="form-group m-form__group row">
							<div class="col-lg-4">
								...
								<input name="directorate_code" id="directorate_code" class="uk-input uk-child-width-1-2" type="text" onchange="check_code()" placeholder="Directorate Code" required>
						...
						<div class="form-group m-form__group row">
							<div class="col-lg-4">
								...
								<input name="directorate_name" id="directorate_name" class="uk-input uk-child-width-1-2" type="text" placeholder="Directorate Name" required>
							</div>
						</div>
						<div class="form-group m-form__group row">
							<div class="col-lg-4">
								...
								<select class="form-control select2-list" name="is_cabang"   id="is_cabang">
						...
						<div>
							...
							<button onclick="location.href = '{{ url('/master/list_directorate')}}'" class="uk-button uk-button-danger fl-button float-right" type="button">Back</button>
						</div>
