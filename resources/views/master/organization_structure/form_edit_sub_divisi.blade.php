	...
	<div class="fl-main-container">
		...
		<div class="fl-container">
			<div class="fl-title-page" >
				...
				<div class="fl-table">
					<form id="form_blade" action="/master/save_subdivisi_edit" method="POST">
						{{ csrf_field() }}
						<div class="form-group m-form__group row">
							...
							<div class="col-lg-4">
								...
								<input name="sub_division_code" id="sub_division_code" class="uk-input uk-child-width-1-2" type="text" onchange="check_code()" placeholder="Sub Division Code" value="{{$subdivisioncode}}" required>
						...
						<div class="form-group m-form__group row">
							<div class="col-lg-4">
								...
								<input name="sub_division_name" id="sub_division_name" class="uk-input uk-child-width-1-2" type="text" placeholder="Division Name" value="{{$subdivisionname}}" required>
							</div>
						</div>
						<div class="form-group m-form__group row">
							<div class="col-lg-4">
