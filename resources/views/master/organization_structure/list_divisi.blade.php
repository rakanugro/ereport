		...
		<div class="fl-container">
			<div class="fl-title-page" >
				...
				<!-- <span style="float:right;margin-top:15px">
					...
					<a href="form_divisi"><button class="uk-button uk-button-primary fl-button" type="button">+</button></a>
					@endif
				</span>
			</div>
			<div class="fl-table">
				<div class="uk-overflow-auto">
					<table class="uk-table uk-table-hover uk-table-middle uk-table-divider" id="divisilist">
						<thead>
						...
						<tbody>	
							...
							<tr>
								...
								<td>
									...
									<div uk-dropdown="mode:click">
										<ul class="uk-nav uk-dropdown-nav">
											<li><a href="/master/form_edit_divisi/{{$items->DIVISION_ID}}">Edit</a></li>
											<li><a href="/master/form_status_divisi/{{$items->DIVISION_ID}}">Status</a></li>
										</ul>
									</div>
								</td>
							</tr>
