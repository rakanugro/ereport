...
<body>
	...
	<div class="fl-main-container">
		...
		<div class="fl-container">
			...
			<div class="fl-table">
				<form id="form_blade" action="#" method="POST">
					{{ csrf_field() }}
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-6">
							...
							<select class="form-control select2-list" id="directorat" name="directorat" disabled>
					...
					<div class="form-group m-form__group row">
						<div class="col-lg-6">
							...
							<select class="form-control select2-list" id="branchoffice" name="branchoffice" disabled>
					...
					<div class="form-group m-form__group row">
						<div class="col-lg-6">
							...
							<select class="form-control select2-list" id="divisi" name="divisi" disabled>
					...
					<div class="form-group m-form__group row">
						<div class="col-lg-6">
							...
							<select class="form-control select2-list" id="sub_divisi" name="sub_divisi" disabled>
					...
					<div class="form-group m-form__group row">
						<div class="col-lg-6">
							...
							<select class="form-control select2-list" name="status"   id="status" disabled>
					...
					<div>
						<button onclick="location.href = '{{ url('master/organization_structure')}}'" class="uk-button uk-button-danger fl-button float-right" type="button">Back</button>
					</div>
					<div>
						<br>
						<br>
