							...
							<ul class="uk-slider-items uk-child-width-1-1@s uk-child-width-1-1@ uk-grid">
								...
								<li>
									<div uk-grid class="uk-grid-small uk-child-width-1-1 uk-child-width-1-4@m uk-child-width-1-2@s">
										...
										<div>
											<div class="uk-card uk-card-default uk-card-body fl-menu-box fl-box-color15">
												<table>
													<tr>
														<td>
															<a href="/sarmut">
																<img src="templateslide/assets/img/image/mastersarmut.jpeg" class="fl-image-figure">
															</a>
														</td>
													</tr>
												</table>								    
										...
										<div>
											<div class="uk-card uk-card-default uk-card-body fl-menu-box fl-box-color16">
												<table>
													<tr>
														<td>
															<a href="/kpi">
																<img src="templateslide/assets/img/image/masterkpi.jpeg" class="fl-image-figure">
															</a>
														</td>
													</tr>
												</table>								    
										...
										<div>
											<div class="uk-card uk-card-default uk-card-body fl-menu-box fl-box-color17">
												<table>
													<tr>
														<td>
															<a href="/tkp">
																<img src="templateslide/assets/img/image/mastertkp.jpeg" class="fl-image-figure">
															</a>
														</td>
													</tr>
												</table>								    
										...
										<div>
											<div class="uk-card uk-card-default uk-card-body fl-menu-box fl-box-color14">
												<table>
													<tr>
														<td>
															<a href="/master/organization_structurex">
