...
<body>
	...
	<div class="fl-main-container">
		...
		<div class="fl-container">
			...
			<div class="fl-table">
				<form id="form_perencanaan" action="/master/sub_indicator_save" method="POST">
					{{ csrf_field() }}
					<div>
						<b>Sub Indicator Name</b>
						<input name="sub_indicator_name" class="uk-input uk-child-width-1-2" type="text" placeholder="Sub Indicator Name" required>
					</div>
					<div>
						<b>Unit</b>
						<input name="sub_unit" class="uk-input uk-child-width-1-2" type="text" placeholder="Unit" required>
					</div>
					<div>
						<br>
					</div>
