		...
		<div class="fl-container">
			...
			<div class="fl-table">
				...
				<input type="hidden" name="id" id="id" value="{{ $id }}">
					<div>
                        ...
                        <select id="sub_division_list" class="form-control select2-list" name="sub_division_list[]" data-validation="required" data-validation-error-msg="Silahkan Pilih Sub Division">
                            ...
                            @foreach($sub_division_list as $subdivision)
                                <option value="{{ $subdivision['SUB_DIVISION_ID'] }}" {{ $selectedsd == $subdivision->SUB_DIVISION_ID ? 'selected="selected"' : '' }}>{{ $subdivision->BRANCH_OFFICE_NAME }} {{ $subdivision->SUB_DIVISION_NAME }}</option>
                            @endforeach
                        </select>
					<div>
					<div>
						<b>Indicator Name</b>
						<input name="indicator_name" class="uk-input uk-child-width-1-2" type="text" value="{{ $indicator_name }}" placeholder="Indicator Name" required>
					</div>
					<div>
						<b>Inputable</b>
					...
					<div>
						<b>Satuan</b>
						<input name="unit" class="uk-input uk-child-width-1-2" type="text" value="{{ $unit }}" placeholder="Unit" required>
					</div>
					<div>
						<b>Polaritas</b>
					...
					<div>
						<b>Formula</b>
						<input id="formula" name="formula" class="uk-input uk-child-width-1-2 readonly"  value="{{ $formula }}" type="text" placeholder="Formula" readonly="readonly">
