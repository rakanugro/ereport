		...
		<div class="fl-container">
			<div class="fl-title-page" >
				...
				<span style="float:right;margin-top:15px">
					<button class="uk-button uk-button-primary fl-button" type="button"><a href="/sop_table/{{$id}}"><font style="color:white">Lihat Lebih Banyak
					</font></a></button>
				</span>
				@endif
			</div>
								...
								<tr>
									<td>
										<div align="center" style="padding:10px">
											...
											<span style="font-size:22px;font-weight:600">Upload SOP</span>
											<div>
