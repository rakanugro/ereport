		...
		<div class="fl-container">
			<div class="fl-title-page" >
				<span style="font-size:20px">				
					...
					Works Instruction (WI) Upload
				</span>
			</div>


			<div class="fl-table">
				<form id="form_blade" action="{{url('wi_upload')}}" enctype="multipart/form-data" method="POST">
				{{ csrf_field() }}
				<input name="id" class="uk-input uk-child-width-1-2"  value="{{$id}}" type="hidden">
                <div>
                    <b>WI File </b>
                ...
                <div>
                    <br>
						...
						<div>
							<button class="uk-button uk-button-primary fl-button" onclick="Upload_organization_structure(this.form.id);return false;">
