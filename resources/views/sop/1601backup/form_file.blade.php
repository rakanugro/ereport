		...
		<div class="fl-container">
			<div class="fl-title-page" >
				...
				<span style="float:right;margin-top:15px">
					<button class="uk-button uk-button-primary fl-button" type="button"><a href="/form_file_table/{{$id}}"><font style="color:white">Lihat Lebih Banyak
					</font></a></button>
				</span>
				@endif
			</div>
								...
								<tr>
									<td>
										<div align="center" style="padding:10px">
											...
											<span style="font-size:22px;font-weight:600">Upload Form File</span>
											<div>
												Title Form File
											</div>
											@if($tes == '1' || $tes == '2')
											<div style="margin-top:15px">
												<a href="/form_file_upload/{{$id}}">
										...
										<tr>
											<td>
												<div align="center">
													...
													<span style="font-size:22px;font-weight:600">Form File {{$i++}}</span>
													<div>
														{{$item->FILE_NAME}}
													</div>
													<div style="margin-top:15px">
														<button class="uk-button uk-button-success fl-button" type="button">
															<a href="{{url('form_download/'.$item->FILE_NAME)}}">Download</a>
														</button>
													</div>
												</div>
											</td>
