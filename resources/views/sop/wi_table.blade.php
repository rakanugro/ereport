		...
		<div class="fl-container">
			<div class="fl-title-page" >
				...
				<span style="float:right;margin-top:15px">
					...
					@endif
					@if($tes == '2')
					<button class="uk-button uk-button-primary fl-button" type="button"><a href="/wi/{{$id}}"><font style="color:white">Lihat Lebih Sedikit
					</font></a></button>
					@endif
				</span>
							...
							<tr>
								...
								<div uk-dropdown="mode:click">
									<ul class="uk-nav uk-dropdown-nav">
										<li><a href="{{url('wi_download/'.$item->FILE_NAME)}}">Download</a></li>
									</ul>
								</div>
							</td>
							</tr>
