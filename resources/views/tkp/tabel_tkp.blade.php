...
<body>
		...
		<div class="fl-container">
			<div class="fl-title-page" >
				...
				<span style="float:right;margin-top:15px">
					<!-- <a href="txtkp"><button class="uk-button uk-button-default fl-button" type="button">TKP</button></a> -->
				...
				<div class="fl-table col-md-12" id="form1">
					<form id="form_mst_kpi" action="/tkp/master_indikator_tkp_save" method="POST">
						{{ csrf_field() }}
						<br>
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
								<h4>
									ADD Master Indikator TKP
								</h4>
							</div>
						</div>
						<div class="form-group m-form__group row">
						...
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
								...
								<input id="target" name="target" class="uk-input uk-child-width-1-2"  value="" type="text" placeholder="Target">
							</div>
						</div>
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
								...
								<input id="bobot" name="bobot" class="uk-input uk-child-width-1-2"  value="" type="text" placeholder="Bobot">
							</div>
						</div>
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
			...
			<div class="fl-table">
				<div class="uk-overflow-auto">
					<table class="uk-table uk-table-hover uk-table-middle uk-table-divider" id="tkp_list">
						<thead>
							<tr class="fl-table-head">
								<th width="5%"></th>
								<th width="25%">Sub Divisi</th>
									...
									<td>
										...
										<div uk-dropdown="mode:click">
											<ul class="uk-nav uk-dropdown-nav">
												<li><a href="tkp/detail/form_msttkpdetail/{{ $data->INDICATOR_ID }}">Detail</a></li>
												...
												@elseif((Auth::user()->ACCESS == 'DVP SUB DIVISI' && $data->STATUS == '3') || (Auth::user()->ACCESS == 'DVP PENGENDALIAN KINERJA DAN JAMINAN MUTU' && $data->STATUS == '3'))
													<li><a href="tkp/status/form_msttkpeditstatus/{{ $data->INDICATOR_ID }}">Status</a></li>
												...
												@elseif((Auth::user()->ACCESS == 'ADMIN SUB DIVISI'  && $data->STATUS == '4' || Auth::user()->ACCESS == 'ADMIN PENGENDALIAN KINERJA DAN JAMINAN MUTU' && $data->STATUS == '4' || Auth::user()->ACCESS == 'ADMIN SUB DIVISI'  && $data->STATUS == '1' || Auth::user()->ACCESS == 'ADMIN PENGENDALIAN KINERJA DAN JAMINAN MUTU' && $data->STATUS == '1'))
													<li><a href="tkp/edit/form_msttkpedit/{{ $data->INDICATOR_ID }}">Edit</a></li>
												@endif
											</ul>
										</div>
									</td>
	...
	<div id="Approvalmodal" uk-modal >
		<div class="uk-modal-dialog uk-modal-body modal-sm">
			<form action="/tkp/master_tkp_approval_indikator" id="approvalForm" method="post">
				{{ csrf_field() }}
	...
	<div id="kembalikanmodal" uk-modal >
		<div class="uk-modal-dialog uk-modal-body modal-sm">
			<form action="/tkp/master_tkp_kembalikan_indikator" id="kembalikanForm" method="post">
				{{ csrf_field() }}
				<div style="height:80px" data-simplebar data-simplebar-auto-hide="true">
					<div>
