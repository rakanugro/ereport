...
<body>
	...
	<div class="fl-main-container">
		...
		<div class="fl-container">
			...
			<div class="fl-table">
				<form id="form_mst_tkp" action="/tkp/master_tkp_edit" method="POST">
				{{ csrf_field() }}
				<input type="hidden" name="id" id="id" value="{{ $id }}">
					<!-- <div>
						...
						<select class="form-control select2-list" id="organize_struct_list" name="organize_struct_list[]" required="required">
					...
					<div>
                        ...
                        <select id="indicator_list" class="form-control select2-list" name="indicator_list[]" required="required">
					...
					<div>
						<button class="uk-button uk-button-primary fl-button" onclick="save_mst_tkp(this.form.id);return false;">
							<i class="fa fa-plus"></i>&nbsp;Update
						</button>
						<button class="uk-button uk-button-danger fl-button" style="float: right;" onclick="location.href = '{{ url('tkp')}}'">
