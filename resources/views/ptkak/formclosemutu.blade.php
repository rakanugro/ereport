		...
		<div class="fl-container">
			<div class="fl-title-page" >
				<span style="font-size:20px">				
					...
					FORM STATUS PERINTAH TINDAKAN KOREKTIF ATAS KETIDAKSESUAIAN (FORM PTKAK)
				</span>
			</div>
			
			<div class="fl-table col-md-12">
				<form id="form_mst_sarmut" action="/ptkak/ptkakeditedclosemutu" enctype="multipart/form-data" method="POST" file="true">
					{{ csrf_field() }}
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-4">
							...
							<input type="text"  class="form-control m-input" name="revisi" id="revisi" value="{{ $revision }}" disabled>
						</div>
						<div class="col-lg-2">
						...
						<div class="col-lg-4">
							...
							<input type="text"  class="form-control m-input" data-date-format="dd/mm/yyyy" name="tanggal" id="tanggal" value="@php if($ptkakdate == NULL){echo ''; }else{echo date('d/m/Y',strtotime($ptkakdate));} @endphp" disabled>
						</div>
						<div class="col-lg-8">
							<label class="">
								&nbsp;
						...
						<div class="col-lg-4">
							...
							<input type="text"  class="form-control m-input" name="halaman" id="halaman" value="{{ $page }}" disabled>
						</div>
					</div>
					<div class="form-group m-form__group row">
						<div class="col-lg-8">
							...
							<input type="text"  class="form-control m-input" name="noptkak" id="noptkak" value="{{ $noptkak }}" disabled>
						</div>
					</div>
					...
					<div class="form-group m-form__group row">
						<div class="col-lg-6">
							...
							<div class="m-radio-inline">
								<label class="m-radio m-radio--solid">
									<input type="radio" name="jenis" id="jenis" value="1" disabled {{ $type == "1" ? 'checked' : '' }}>
									Tindakan Perbaikan
									<span></span>
								</label>
								<label class="m-radio m-radio--solid">
									<input type="radio" name="jenis" id="jenis" value="2" disabled {{ $type == "2" ? 'checked' : '' }}>
									Tindakan Pencegahan
									<span></span>
								</label>
							</div>
						...
						<div class="col-lg-3">
							...
							<div class="m-radio-inline">
								...
								<label class="m-radio m-radio--solid">
									<input type="radio" name="sumber" id="sumber" value="{{ $data->SOURCE_ID}}" disabled {{ $sbr == $data->SOURCE_ID ? 'checked' : '' }}>
									{{ $data->SOURCE}}
									<span></span>
								</label>
								@endforeach
					...
					<div class="form-group m-form__group row">
						<div class="col-lg-6">
							...
							<select class="form-control select2-list" id="pengusulauditor" name="pengusulauditor" disabled>
					...
					<div class="form-group m-form__group row">
						<div class="col-lg-6">
							...
							<select class="form-control select2-list" id="ditujuakan" name="ditujuakan" disabled>
					...
					<div class="form-group m-form__group row">
						<div class="col-lg-8">
							...
							<textarea type="text"  class="form-control m-input" name="uraian" id="uraian" disabled>{{ $uraian }}</textarea>
						</div>
					</div>
					<div class="form-group m-form__group row">
						<div class="col-lg-8">
							...
							<input type="text"  class="form-control m-input" name="lokasi" id="lokasi" value="{{ $loc }}" disabled>
						</div>
					</div>
					<div class="form-group m-form__group row">
						<div class="col-lg-8">
					...
					<div class="form-group m-form__group row">
						<div class="col-lg-8">
							...
							<input type="text"  class="form-control m-input" name="referensi" id="referensi" value="{{ $ptkakref }}" disabled>
						</div>	
					</div>
					<br>
					<hr style="border: 1px solid;">
					<div class="form-group m-form__group row">
						<div class="col-lg-12">
							...
							<textarea type="text"  class="form-control m-input" name="tindakan" id="tindakan" disabled>{{ $firstact }}</textarea>
						</div>
					</div>
					<div class="form-group m-form__group row">
						<div class="col-lg-12">
					...
					<div class="form-group m-form__group row">
						<div class="col-lg-12">
							...
							<textarea type="text"  class="form-control m-input" name="tindakankorek" id="tindakankorek" disabled>{{ $act }}</textarea>
						</div>
					</div>
					<div class="form-group m-form__group row">
						<div class="col-lg-12">
