		...
		<div class="fl-container">
			<div class="fl-title-page" >
				<span style="font-size:20px">				
					...
					FORM PREVIEW PERINTAH TINDAKAN KOREKTIF ATAS KETIDAKSESUAIAN (FORM PTKAK)
				</span>
			</div>
			
			<div class="fl-table col-md-12">
				<form id="form_mst_sarmut" action="#" enctype="multipart/form-data" method="POST" file="true">
					{{ csrf_field() }}
