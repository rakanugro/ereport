	...
	<div class="fl-main-container">
		...
		<div class="fl-container">
			<div class="fl-title-page" >
				...
				@endif
					<button class="uk-button uk-button-primary fl-button" type="button"><a href="{{url('management_report_index')}}"><font style="color:white">Lihat Lebih Sedikit
					</font></a></button>
				</span>
							...
							<tr>
								...
								<div uk-dropdown="mode:click">
									<ul class="uk-nav uk-dropdown-nav">
										<li><a href="{{url('management_report_download/'.$item->FILE_NAME)}}">Download</a></li>
									</ul>
								</div>
							</td>
							</tr>
