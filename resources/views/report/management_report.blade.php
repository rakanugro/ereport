		...
		<div class="fl-container">
			<div class="fl-title-page" >
				...
				<span style="float:right;margin-top:15px">
					<button class="uk-button uk-button-primary fl-button" type="button"><a href="{{url('report_table')}}"><font style="color:white">Lihat Lebih Banyak
					</font></a></button>
				</span>
			</div>
									...
									<td>
										<div align="center" style="padding:10px">
											...
											<div style="margin-top:15px">
												<a href="{{url('management_report_upload')}}">
										...
										<tr>
											<td>
												<div align="center">
													...
													<span style="font-size:22px;font-weight:600">Report {{$i++}}</span>
													<div>
														{{$item->FILE_NAME}}
													</div>
													<div style="margin-top:15px">
														<button class="uk-button uk-button-success fl-button" type="button">
															<a href="{{url('management_report_download/'.$item->FILE_NAME)}}">Download</a>
														</button>
													</div>
												</div
											</td>
